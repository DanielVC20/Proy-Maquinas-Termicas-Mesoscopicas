...
plt.ylabel("y")
plt.legend()
plt.title("Compresion isotérmica")
...
plt.ylabel("y")
plt.legend()
plt.title("Compresion adiabática")
plt.savefig("FigBC-1.png")

W2_prom = np.mean(W2_stochastic)
W2_calc = T_C - T_B

res2_prom = " = {:.3f}".format(W2_prom)
...
plt.ylabel("y")
plt.legend()
plt.title("Expansición isotérmica")
...
plt.ylabel("y")
plt.legend()
plt.title("Expansición adiabática")
plt.savefig("FigDA-1.png")

W4_prom = np.mean(W4_stochastic)
W4_calc = T_A - T_D

res4_prom = " = {:.3f}".format(W4_prom)
...
res_ciclo_prom = " = {:.3f}".format(W_ciclo_prom)
